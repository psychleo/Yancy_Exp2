    ...
    for i=1:size(csvdata{1,1},1)
        if csvdata{j-2,3}{i,1}~= ''''& strcmp(csvdata{j-2,3}{i,1},'""')~=1& strcmp(csvdata{j-2,3}{i,1},'"trial_index"')~=1;
            ...
            if index(i,1)==1
                ...
                if strcmp(csvdata{j-2,11}{12,1}(1:1),'"') ==1
                    DATAsubject(j-2).Sex = str2double(csvdata{j-2,11}{12,1}(2:2));
                elseif strcmp(csvdata{j-2,11}{12,1}(1:1),'"') ~=1
                    DATAsubject(j-2).Sex = str2double(csvdata{j-2,11}{12,1});
                end
                if strcmp(csvdata{j-2,11}{13,1}(1:1),'"') ==1
                    DATAsubject(j-2).Age = str2double(csvdata{j-2,11}{13,1}(2:3));
                elseif strcmp(csvdata{j-2,11}{13,1}(1:1),'"') ~=1
                    DATAsubject(j-2).Age = str2double(csvdata{j-2,11}{13,1});
                end
                if strcmp(csvdata{j-2,11}{14,1}(1:1),'"') ==1
                DATAsubject(j-2).Edu = str2double(csvdata{j-2,11}{14,1}(2:2));
                elseif strcmp(csvdata{j-2,11}{14,1}(1:1),'"') ~=1
                    DATAsubject(j-2).Edu = str2double(csvdata{j-2,11}{14,1}(1:1));
                end
                ...
                DATAsubject(j-2).trial(n).KB = csvdata{j-2,12}{i,1};
                % 情绪
...
for j=1:DATA_num-2
    ...
    for i=1:130
        if DATAsubject(j).trial(i).Block == 1;
            DATAsubject(j).B1PreEmo = str2double(DATAsubject(j).trial(8).Emotion);
...
for j=1:DATA_num-2
    ...
    for i=1:130
        ...
        if DATAsubject(j).trial(i).Block == 2;
            DATAsubject(j).B2PreEmo = str2double(DATAsubject(j).trial(34).Emotion);
            DATAsubject(j).B2PstEmo1 = str2double(DATAsubject(j).trial(38).Emotion);
            DATAsubject(j).B2PstEmo2 = str2double(DATAsubject(j).trial(56).Emotion);
            if i >=40 & i<= 55
                if strcmp(DATAsubject(j).trial(i).stimuls,'"+"')~=1
                    if strcmp(DATAsubject(j).trial(i).stimuls(6:7),'IM')
...
for j=1:DATA_num-2
    ...
    for i=1:130
        ...
        if DATAsubject(j).trial(i).Block == 3;
            ...
            DATAsubject(j).B3PstEmo1 = str2double(DATAsubject(j).trial(64).Emotion);
            DATAsubject(j).B3PstEmo2 = str2double(DATAsubject(j).trial(82).Emotion);
            if i >=67 & i<= 81
                if strcmp(DATAsubject(j).trial(i).stimuls,'"+"')~=1
                    if strcmp(DATAsubject(j).trial(i).stimuls(6:7),'IM')
...
for j=1:DATA_num-2
    ...
    for i=1:130
        if DATAsubject(j).trial(i).Block == 4;
            DATAsubject(j).B4PreEmo = str2double(DATAsubject(j).trial(86).Emotion);
            DATAsubject(j).B4PstEmo1 = str2double(DATAsubject(j).trial(90).Emotion);
            DATAsubject(j).B4PstEmo2 = str2double(DATAsubject(j).trial(108).Emotion);
            if i >=93 & i<= 107
                if strcmp(DATAsubject(j).trial(i).stimuls,'"+"')~=1
                    if strcmp(DATAsubject(j).trial(i).stimuls(6:7),'IM')
...
for j=1:DATA_num-2
    ...
    for i=1:130
        if DATAsubject(j).trial(i).Block == 5;
            DATAsubject(j).B5PreEmo = str2double(DATAsubject(j).trial(112).Emotion);
            DATAsubject(j).B5PstEmo1 = str2double(DATAsubject(j).trial(116).Emotion);
            DATAsubject(j).B5PstEmo2 = str2double(DATAsubject(j).trial(134).Emotion);
            if i >=119 & i<= 133
                if strcmp(DATAsubject(j).trial(i).stimuls,'"+"')~=1
                    if strcmp(DATAsubject(j).trial(i).stimuls(6:7),'IM')
...
for j=1:DATA_num-2    
    ...
    % (1)B1_PE
    % a.B1_PE_RT
    DATAsubject(j).B1_PE_Y_RT = sum(RT(1,(stimulstype==2)&(KB==68)));
    DATAsubject(j).B1_PE_N_RT = sum(RT(1,(stimulstype==2)&(KB==75)));
    % b.B1_PE_Y
    DATAsubject(j).B1_PE_Y = sum((stimulstype==2)&(KB==68));
    % (2)B1_IM
    % B1_IM_RT
    DATAsubject(j).B1_IM_Y_RT = sum(RT(1,(stimulstype==1)&(KB==68)));
    DATAsubject(j).B1_IM_N_RT = sum(RT(1,(stimulstype==1)&(KB==75)));
    % B1_IM_Y
    DATAsubject(j).B1_IM_Y = sum((stimulstype==1)&(KB==68));
    % (3)B1_NO
    % B1_NO_RT
    DATAsubject(j).B1_NO_Y_RT = sum(RT(1,(stimulstype==3)&(KB==68)));
    DATAsubject(j).B1_NO_N_RT = sum(RT(1,(stimulstype==3)&(KB==75)));
    % B1_NO_Y
...
for j=1:DATA_num-2    
    ...
    % (1)B2_PE
    % a.B2_PE_RT
    DATAsubject(j).B2_PE_Y_RT = sum(RT(1,(stimulstype==2)&(KB==68)));
    DATAsubject(j).B2_PE_N_RT = sum(RT(1,(stimulstype==2)&(KB==75)));
    % b.B2_PE_Y
    DATAsubject(j).B2_PE_Y = sum((stimulstype==2)&(KB==68));
    % (2)B2_IM
    % B2_IM_RT
    DATAsubject(j).B2_IM_Y_RT = sum(RT(1,(stimulstype==1)&(KB==68)));
    DATAsubject(j).B2_IM_N_RT = sum(RT(1,(stimulstype==1)&(KB==75)));
    % B2_IM_Y
    DATAsubject(j).B2_IM_Y = sum((stimulstype==1)&(KB==68));
    % (3)B2_NO
    % B2_NO_RT
    DATAsubject(j).B2_NO_Y_RT = sum(RT(1,(stimulstype==3)&(KB==68)));
    DATAsubject(j).B2_NO_N_RT = sum(RT(1,(stimulstype==3)&(KB==75)));
    % B2_NO_Y
...
for j=1:DATA_num-2    
    ...
    % (1)B3_PE
    % a.B3_PE_RT
    DATAsubject(j).B3_PE_Y_RT = sum(RT(1,(stimulstype==2)&(KB==68)));
    DATAsubject(j).B3_PE_N_RT = sum(RT(1,(stimulstype==2)&(KB==75)));
    % b.B3_PE_Y
    DATAsubject(j).B3_PE_Y = sum((stimulstype==2)&(KB==68));
    % (2)B3_IM
    % B3_IM_RT
    DATAsubject(j).B3_IM_Y_RT = sum(RT(1,(stimulstype==1)&(KB==68)));
    DATAsubject(j).B3_IM_N_RT = sum(RT(1,(stimulstype==1)&(KB==75)));
    % B3_IM_Y
    DATAsubject(j).B3_IM_Y = sum((stimulstype==1)&(KB==68));
    % (3)B3_NO
    % B3_NO_RT
    DATAsubject(j).B3_NO_Y_RT = sum(RT(1,(stimulstype==3)&(KB==68)));
    DATAsubject(j).B3_NO_N_RT = sum(RT(1,(stimulstype==3)&(KB==75)));
    % B3_NO_Y
...
for j=1:DATA_num-2    
    ...
    % (1)B4_PE
    % a.B4_PE_RT
    DATAsubject(j).B4_PE_Y_RT = sum(RT(1,(stimulstype==2)&(KB==68)));
    DATAsubject(j).B4_PE_N_RT = sum(RT(1,(stimulstype==2)&(KB==75)));
    % b.B4_PE_Y
    DATAsubject(j).B4_PE_Y = sum((stimulstype==2)&(KB==68));
    % (2)B4_IM
    % B4_IM_RT
    DATAsubject(j).B4_IM_Y_RT = sum(RT(1,(stimulstype==1)&(KB==68)));
    DATAsubject(j).B4_IM_N_RT = sum(RT(1,(stimulstype==1)&(KB==75)));
    % B4_IM_Y
    DATAsubject(j).B4_IM_Y = sum((stimulstype==1)&(KB==68));
    % (3)B4_NO
    % B4_NO_RT
    DATAsubject(j).B4_NO_Y_RT = sum(RT(1,(stimulstype==3)&(KB==68)));
    DATAsubject(j).B4_NO_N_RT = sum(RT(1,(stimulstype==3)&(KB==75)));
    % B4_NO_Y
...
for j=1:DATA_num-2    
    ...
    % (1)B5_PE
    % a.B5_PE_RT
    DATAsubject(j).B5_PE_Y_RT = sum(RT(1,(stimulstype==2)&(KB==68)));
    DATAsubject(j).B5_PE_N_RT = sum(RT(1,(stimulstype==2)&(KB==75)));
    % b.B5_PE_Y
    DATAsubject(j).B5_PE_Y = sum((stimulstype==2)&(KB==68));
    % (2)B5_IM
    % B5_IM_RT
    DATAsubject(j).B5_IM_Y_RT = sum(RT(1,(stimulstype==1)&(KB==68)));
    DATAsubject(j).B5_IM_N_RT = sum(RT(1,(stimulstype==1)&(KB==75)));
    % B5_IM_Y
    DATAsubject(j).B5_IM_Y = sum((stimulstype==1)&(KB==68));
    % (3)B5_NO
    % B5_NO_RT
    DATAsubject(j).B5_NO_Y_RT = sum(RT(1,(stimulstype==3)&(KB==68)));
    DATAsubject(j).B5_NO_N_RT = sum(RT(1,(stimulstype==3)&(KB==75)));
    % B5_NO_Y
...
for j=1:DATA_num-2
    ...
    % IM_RT
    DATASV(j).IM_Y_RT = sum ([DATAsubject(j).B1_IM_Y_RT,DATAsubject(j).B2_IM_Y_RT,DATAsubject(j).B3_IM_Y_RT,DATAsubject(j).B4_IM_Y_RT,DATAsubject(j).B5_IM_Y_RT]);
    DATASV(j).IM_N_RT = sum ([DATAsubject(j).B1_IM_N_RT,DATAsubject(j).B2_IM_N_RT,DATAsubject(j).B3_IM_N_RT,DATAsubject(j).B4_IM_N_RT,DATAsubject(j).B5_IM_N_RT]);
    if DATASV(j).IM_Y > 0 & DATASV(j).IM_Y < 15
        DATASV(j).IM_Y_RT = DATASV(j).IM_Y_RT / DATASV(j).IM_Y;
        DATASV(j).IM_N_RT = DATASV(j).IM_N_RT / (15-DATASV(j).IM_Y);
    elseif DATASV(j).IM_Y == 0
        DATASV(j).IM_Y_RT = 0;
        DATASV(j).IM_N_RT = DATASV(j).IM_N_RT / (15-DATASV(j).IM_Y);
    elseif DATASV(j).IM_Y == 15
        DATASV(j).IM_Y_RT = DATASV(j).IM_Y_RT / DATASV(j).IM_Y;
        DATASV(j).IM_N_RT = 0;
    end
    % PE
    ...
    % PE_RT
    DATASV(j).PE_Y_RT = sum ([DATAsubject(j).B1_PE_Y_RT,DATAsubject(j).B2_PE_Y_RT,DATAsubject(j).B3_PE_Y_RT,DATAsubject(j).B4_PE_Y_RT,DATAsubject(j).B5_PE_Y_RT]);
    DATASV(j).PE_N_RT = sum ([DATAsubject(j).B1_PE_N_RT,DATAsubject(j).B2_PE_N_RT,DATAsubject(j).B3_PE_N_RT,DATAsubject(j).B4_PE_N_RT,DATAsubject(j).B5_PE_N_RT]);
    if DATASV(j).PE_Y > 0 & DATASV(j).PE_Y < 15
        DATASV(j).PE_Y_RT = DATASV(j).PE_Y_RT / DATASV(j).PE_Y;
        DATASV(j).PE_N_RT = DATASV(j).PE_N_RT / (15-DATASV(j).PE_Y);
    elseif DATASV(j).PE_Y == 0
        DATASV(j).PE_Y_RT = 0;
        DATASV(j).PE_N_RT = DATASV(j).PE_N_RT / (15-DATASV(j).PE_Y);
    elseif DATASV(j).PE_Y == 15
        DATASV(j).PE_Y_RT = DATASV(j).PE_Y_RT / DATASV(j).PE_Y;
        DATASV(j).PE_N_RT = 0;
    end
    % NO
    ...
    % NO_RT
    DATASV(j).NO_Y_RT = sum ([DATAsubject(j).B1_NO_Y_RT,DATAsubject(j).B2_NO_Y_RT,DATAsubject(j).B3_NO_Y_RT,DATAsubject(j).B4_NO_Y_RT,DATAsubject(j).B5_NO_Y_RT]);
    DATASV(j).NO_N_RT = sum ([DATAsubject(j).B1_NO_N_RT,DATAsubject(j).B2_NO_N_RT,DATAsubject(j).B3_NO_N_RT,DATAsubject(j).B4_NO_N_RT,DATAsubject(j).B5_NO_N_RT]);
    if DATASV(j).NO_Y > 0 & DATASV(j).NO_Y < 10
        DATASV(j).NO_Y_RT = DATASV(j).NO_Y_RT / DATASV(j).NO_Y;
        DATASV(j).NO_N_RT = DATASV(j).NO_N_RT / (15-DATASV(j).NO_Y);
    elseif DATASV(j).NO_Y == 0
        DATASV(j).NO_Y_RT = 0;
        DATASV(j).NO_N_RT = DATASV(j).NO_N_RT / (15-DATASV(j).NO_Y);
    elseif DATASV(j).NO_Y == 10
        DATASV(j).NO_Y_RT = DATASV(j).NO_Y_RT / DATASV(j).NO_Y;
        DATASV(j).NO_N_RT = 0;
    end
end
